...
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞RAKIB BOSS☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 RAKIB🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ www.facebook.com/rakib.mobile.01601150650\n👋For Any Kind Of Help Contact On Email  👉rakib.ali.csl @gmail.com😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Rakib  ❤️ My Creator. He loves me & Edit Me Daily. Ei bot tumader jonno noy eta sudhu amar boss Rakib er jonno, bosser kotha bolar manush nai to.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot admin  k")) {
     return api.sendMessage("He is Rakib. He Gives his name Rakib everywhare", threadID);
   };

   if ((event.body.toLowerCase() == "Amare biya korbayni") || (event.body.toLowerCase() == "Amake kew biye korba?")) {
     return api.sendMessage("Hmm obossoi korbo kintu baccata🧑‍🔬 tumar pete jonmo diba😁?", threadID);
   };
