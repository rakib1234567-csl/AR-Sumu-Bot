...
if ((event.body.toLowerCase() == "tumi ki koro") || (event.body.toLowerCase() == "U")) {
     return api.sendMessage("আর কিতা করতাম বইয়া বইয়া তুমার কথা ছিন্তা কররাম🤩 তুমি কিতা কররায়", threadID);
   };
...
if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "mc")) {
...
  if ((event.body.toLowerCase() == "Rakib Ali") || (event.body.toLowerCase() == "Rakib bai") || (event.body.toLowerCase() == "@Rakib ッ") || (event.body.toLowerCase() == "rakib")) {
     return api.sendMessage("উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);    
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rakib ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rakib.\nতার সাতে যোগাযোগ করবেন WhatsApp :- +8016011t0650", threadID);
   };
...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami rakib) || (event.body.toLowerCase() == "cup sala ami rakib) || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "Fahima") || (event.body.toLowerCase() == "@Fahima ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রাকিবের বউ এর আইডি😠🥰⛏️", threadID);
   };
...
  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "Jannath")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাকিব  এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Sultan") || (event.body.toLowerCase() == "Jaydul")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস রাকিবের  বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
...
   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "Kemon aco") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
