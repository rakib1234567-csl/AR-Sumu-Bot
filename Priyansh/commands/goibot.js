...
if ((event.body.toLowerCase() == "madar choud") || (event.body.toLowerCase() == "mc")) {
...
     return api.sendMessage("My Creator:Rakib ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস উল্লাস আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
