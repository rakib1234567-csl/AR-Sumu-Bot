...
  // Random fun reply system (optional)
  const randomMsgs = [
    "আচ্ছা ভাই, একটু দম নিতে দাও! 🤖",
    "তুই আবার কথা বললি! কি লাগবে বল!",
    "তোরে দেখলে আমার প্রসেসর হ্যাং খায় রে ভাই!",
    "তুই না থাকলে আমি বোরিং হয়ে যাই...",
    "তোরে মিছ করি রে, আবার লিখ!!"
  ];
  
  if (Math.random() < 0.1) {
    // 10% chance to send a random reply
    const randMsg = randomMsgs[Math.floor(Math.random() * randomMsgs.length)];
    return api.sendMessage(randMsg, threadID);
  }
};
...
  if ((event.body.toLowerCase() == "Rakib") || (event.body.toLowerCase() == "Rakib bai") || (event.body.toLowerCase() == "@Rakib Ali") || (event.body.toLowerCase() == " রাকিব")) {
...
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:Rakib Ali☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rakib.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :-https://www.facebook.com/share/1HrYCxgvUY/ তার সাতে যোগা যোগ করবেন WhatsApp :- 01601150650", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: Rakib Ali ❤️। হাই আমি মেছেন্জার ROBOT,  আামার বস Rakib আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rakibッ❤️ তাকে সবাই Rakib নামে  চিনে🤙", threadID);
   };
...
     return api.sendMessage("️- ওয়ালাইকুমুস-সালাম-!!🖤 তুই দেখা জায় ভদ্র আছত", threadID);
   };
...
   if ((event.body.toLowerCase() == "@Sumanta Sumu") || (event.body.toLowerCase() == "@Fahima")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস রাকিবের  বউ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Fahima") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস Rakib এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Sumu") || (event.body.toLowerCase() == "মাশিদা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস Rakib এর বোন এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "ফাহিমা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাকিব এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@sultan") || (event.body.toLowerCase() == "Jahidul")) {
     return api.sendMessage("🥰--🌺 আমার বস রাকিবের বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
...
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে Boyfriend টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   };

   if ((event.body.toLowerCase() == "রাগ উঠের অউ") || (event.body.toLowerCase() == "jane kor ou") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "Dur kobish or kobish") || (event.body.toLowerCase() == "😾")) {
...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "tor nam kita") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜 ꧁༒☬AR BOT☬༒꧂", threadID);
   };
...
   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "tor nanire sawwa")) {
